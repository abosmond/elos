<!-- content starts -->
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="#">Detail Analisis Kredit</a>
					</li>
				</ul>
			</div>
				...
				<div class="box span12">
					...
					<div class="box-content">
						...
						<h2><i class="icon-edit"></i> Checklist Analisa</h2>						
							...
							<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> Checklist Resiko</h2>						
					</div>
							<div class="control-group">
							...
							<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> Checklist Agunan</h2>						
					</div>
							...
							?>
							<div class="control-group">
								<label for="jenis_agunan" class="control-label">CEV Tanah</label>
								<div class='controls'>
								    Rp <?=number_format($cef_tanah, 0, '', ',');?>
								</div>
							</div><div class="control-group">
							...
							<div class="form-actions">
							  <a href="<?=base_url()?>analisis_kredit/proses_analisis/<?=$p->id?>" class="btn btn-primary">Proses</a>
