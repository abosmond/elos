				...
				<div class="box span12">
					...
					<div class="box-content">
						...
						<h2><i class="icon-edit"></i> Nilai CEV Agunan</h2>						
							...
							<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> Hasil Usulan AO</h2>						
					</div>
							...
							<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> Hasil Lanjutan SPV</h2>						
					</div>
							...
							<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> Hasil Putusan Branch Manager</h2>						
					</div>
							...
							<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> Perjanjian Kredit</h2>						
					</div>
					
							<div class="form-actions">
							  <a href="<?=base_url()?>nl" class="btn btn-primary">Kembali</a>							  
							</div>
